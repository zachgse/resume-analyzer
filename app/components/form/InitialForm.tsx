...
const InitialForm = ({
    ...
    return (
        <form onSubmit={handleSubmit(submitHandler)} 
            ...
            <p className="font-semibold text-gray-500 text-xs my-4 md:p-0 p-4">Note: Fill up the fields to generate your AI-powered ATS format resume with Google Gemini model</p>
